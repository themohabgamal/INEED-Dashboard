...
const Color primaryColor = Color(0xFF1230AE);


dynamic primary = const Color(0xffA91D3A);
//const Color(0xff3499cc);
dynamic grey = const Color(0xffC0C2CB);
dynamic backgroundColor = Colors.grey[100];
dynamic buttonColor = const Color(0xffdc143c);
dynamic DropDownColor = Colors.grey[200]!;
dynamic imageCardColor = Colors.grey[200]!;
dynamic greyTextColor = Colors.grey;
dynamic appBarColor = const Color(0xffA91D3A);
dynamic iconColor = const Color(0xffb4a7d6);
dynamic  appBarIconColor = Colors.white;
dynamic  inActiveIconColor = Colors.grey[400]!;
dynamic activeIconColor = Colors.white;
...
dynamic mainTextColor = Colors.white;

dynamic secondaryTextColor = Colors.black;
dynamic kTextConvert=Colors.black;
dynamic cardColor = Colors.white;
